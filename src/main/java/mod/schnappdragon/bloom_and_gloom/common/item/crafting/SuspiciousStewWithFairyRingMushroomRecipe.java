package mod.schnappdragon.bloom_and_gloom.common.item.crafting;

import mod.schnappdragon.bloom_and_gloom.core.registry.BGItems;
import mod.schnappdragon.bloom_and_gloom.core.registry.BGRecipeSerializers;
        ...
        for(int i = 0; i < inv.getSizeInventory(); ++i) {
            ...
            if (!itemstack.isEmpty()) {
                if (itemstack.getItem() == Blocks.BROWN_MUSHROOM.asItem() && !brown)
                    ...
                    red = true;
                else if (itemstack.getItem() == BGItems.FAIRY_RING_MUSHROOM.get() && !fairy)
                    fairy = true;
