...
public class BGConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> PATCH_BALL_CACTUS = Feature.RANDOM_PATCH.withConfiguration(new BlockClusterFeatureConfig.Builder(new WeightedBlockStateProvider().addWeightedBlockstate(BGBlocks.FLOWERING_ORANGE_BALL_CACTUS.get().getDefaultState(), 1).addWeightedBlockstate(BGBlocks.FLOWERING_PINK_BALL_CACTUS.get().getDefaultState(), 1).addWeightedBlockstate(BGBlocks.FLOWERING_RED_BALL_CACTUS.get().getDefaultState(), 1).addWeightedBlockstate(BGBlocks.FLOWERING_YELLOW_BALL_CACTUS.get().getDefaultState(), 1), SimpleBlockPlacer.PLACER).xSpread(5).ySpread(1).zSpread(5).tries(12).build()).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).chance(512);
    public static final ConfiguredFeature<?, ?> PATCH_ORANGE_BALL_CACTUS = Feature.RANDOM_PATCH.withConfiguration(new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BGBlocks.FLOWERING_ORANGE_BALL_CACTUS.get().getDefaultState()), SimpleBlockPlacer.PLACER).xSpread(4).ySpread(1).zSpread(4).tries(8).build()).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).chance(128);
    public static final ConfiguredFeature<?, ?> PATCH_PINK_BALL_CACTUS = Feature.RANDOM_PATCH.withConfiguration(new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BGBlocks.FLOWERING_PINK_BALL_CACTUS.get().getDefaultState()), SimpleBlockPlacer.PLACER).xSpread(4).ySpread(1).zSpread(4).tries(8).build()).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).chance(128);
    public static final ConfiguredFeature<?, ?> PATCH_RED_BALL_CACTUS = Feature.RANDOM_PATCH.withConfiguration(new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BGBlocks.FLOWERING_RED_BALL_CACTUS.get().getDefaultState()), SimpleBlockPlacer.PLACER).xSpread(4).ySpread(1).zSpread(4).tries(8).build()).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).chance(128);
    public static final ConfiguredFeature<?, ?> PATCH_YELLOW_BALL_CACTUS = Feature.RANDOM_PATCH.withConfiguration(new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BGBlocks.FLOWERING_YELLOW_BALL_CACTUS.get().getDefaultState()), SimpleBlockPlacer.PLACER).xSpread(4).ySpread(1).zSpread(4).tries(8).build()).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).chance(128);
