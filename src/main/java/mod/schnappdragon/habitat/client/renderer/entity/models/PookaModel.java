...
public class PookaModel<T extends PookaEntity> extends EntityModel<T> {
    ...
    public PookaModel() {
        ...
        this.pookaLeftEarBase = new ModelRenderer(this, 1, 6);
    ...
    public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.pookaRightEarBase.rotateAngleX = this.pookaRightEar.rotateAngleX;
        this.pookaLeftEarBase.rotateAngleX = this.pookaLeftEar.rotateAngleX;
        ...
        this.pookaRightEarBase.rotateAngleY = this.pookaRightEar.rotateAngleY;
        this.pookaLeftEarBase.rotateAngleY = this.pookaLeftEar.rotateAngleY;
