...
public class SlimeDripParticle {
    public static class DrippingSlimeFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle makeParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            DripParticle.Dripping dripparticle$dripping = new DripParticle.Dripping(worldIn, x, y, z, Fluids.EMPTY, HabitatParticleTypes.FALLING_SLIME.get());
    ...
    public static class FallingSlimeFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle makeParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            DripParticle dripparticle = new SlimeDripParticle.FallingSlimeParticle(worldIn, x, y, z, Fluids.EMPTY, HabitatParticleTypes.LANDING_SLIME.get());
