...
public class HabitatFeatures {
    ...
    public final static RegistryObject<Feature<NoneFeatureConfiguration>> SLIME_FERN_FEATURE = FEATURES.register("slime_fern",
            () -> new SlimeFernFeature(NoneFeatureConfiguration.CODEC));
