...
public class HabitatBlocks {
    ...
    public static final RegistryObject<Block> RAFFLESIA = BLOCKS.register("rafflesia", () -> new RafflesiaBlock(BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.COLOR_RED).instabreak().sound(SoundType.GRASS).randomTicks().noCollission().noOcclusion()));
    ...
    public static final RegistryObject<Block> KABLOOM_FRUIT_PILE = BLOCKS.register("kabloom_fruit_pile", () -> new KabloomFruitPileBlock(BlockBehaviour.Properties.of(Material.GRASS, MaterialColor.COLOR_GREEN).strength(0.4F).sound(SoundType.WOOL).noOcclusion()));
    public static final RegistryObject<Block> KABLOOM_PULP_BLOCK = BLOCKS.register("kabloom_pulp_block", () -> new KabloomPulpBlock(BlockBehaviour.Properties.of(Material.GRASS, MaterialColor.GRASS).sound(SoundType.SLIME_BLOCK).noOcclusion()));
    ...
    public static final RegistryObject<Block> ORANGE_BALL_CACTUS = BLOCKS.register("orange_ball_cactus", () -> new BallCactusBlock(BallCactusColor.ORANGE, BlockBehaviour.Properties.of(Material.CACTUS).strength(1).sound(SoundType.WOOL).noOcclusion().randomTicks()));
    public static final RegistryObject<Block> PINK_BALL_CACTUS = BLOCKS.register("pink_ball_cactus", () -> new BallCactusBlock(BallCactusColor.PINK, BlockBehaviour.Properties.of(Material.CACTUS).strength(1).sound(SoundType.WOOL).noOcclusion().randomTicks()));
    public static final RegistryObject<Block> RED_BALL_CACTUS = BLOCKS.register("red_ball_cactus", () -> new BallCactusBlock(BallCactusColor.RED, BlockBehaviour.Properties.of(Material.CACTUS).strength(1).sound(SoundType.WOOL).noOcclusion().randomTicks()));
    public static final RegistryObject<Block> YELLOW_BALL_CACTUS = BLOCKS.register("yellow_ball_cactus", () -> new BallCactusBlock(BallCactusColor.YELLOW, BlockBehaviour.Properties.of(Material.CACTUS).strength(1).sound(SoundType.WOOL).noOcclusion().randomTicks()));
    public static final RegistryObject<Block> FLOWERING_ORANGE_BALL_CACTUS = BLOCKS.register("flowering_orange_ball_cactus", () -> new FloweringBallCactusBlock(BallCactusColor.ORANGE, BlockBehaviour.Properties.of(Material.CACTUS).strength(1).sound(SoundType.WOOL).noOcclusion()));
    public static final RegistryObject<Block> FLOWERING_PINK_BALL_CACTUS = BLOCKS.register("flowering_pink_ball_cactus", () -> new FloweringBallCactusBlock(BallCactusColor.PINK, BlockBehaviour.Properties.of(Material.CACTUS).strength(1).sound(SoundType.WOOL).noOcclusion()));
    public static final RegistryObject<Block> FLOWERING_RED_BALL_CACTUS = BLOCKS.register("flowering_red_ball_cactus", () -> new FloweringBallCactusBlock(BallCactusColor.RED, BlockBehaviour.Properties.of(Material.CACTUS).strength(1).sound(SoundType.WOOL).noOcclusion()));
    public static final RegistryObject<Block> FLOWERING_YELLOW_BALL_CACTUS = BLOCKS.register("flowering_yellow_ball_cactus", () -> new FloweringBallCactusBlock(BallCactusColor.YELLOW, BlockBehaviour.Properties.of(Material.CACTUS).strength(1).sound(SoundType.WOOL).noOcclusion()));
    ...
    public static final RegistryObject<Block> FAIRY_SPORE_LANTERN = BLOCKS.register("fairy_spore_lantern", () -> new FairySporeLantern(BlockBehaviour.Properties.of(Material.METAL).requiresCorrectToolForDrops().strength(3.5F).sound(SoundType.LANTERN).lightLevel((state) -> 12).noOcclusion()));
    ...
    public static final RegistryObject<Block> FAIRY_RING_MUSHROOM_LADDER = BLOCKS.register("fairy_ring_mushroom_ladder", () -> new LadderBlock(BlockBehaviour.Properties.of(Material.DECORATION).harvestTool(ToolType.AXE).strength(0.4F).sound(SoundType.LADDER).noOcclusion()));
