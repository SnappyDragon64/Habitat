...
public class HabitatItems {
    ...
    public static final RegistryObject<Item> KABLOOM_PULP_BLOCK = ITEMS.register("kabloom_pulp_block", () -> new BlockItem(HabitatBlocks.KABLOOM_PULP_BLOCK.get(), new Item.Properties().group(ItemGroup.DECORATIONS)));
