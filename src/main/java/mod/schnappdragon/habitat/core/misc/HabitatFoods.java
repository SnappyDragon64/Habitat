...
public class HabitatFoods {
    public static final Food KABLOOM_PULP = new Food.Builder().hunger(2).saturation(0.3F).effect(() -> new EffectInstance(HabitatEffects.BLAST_ENDURANCE.get(), 900, 0), 1.0F).build();
